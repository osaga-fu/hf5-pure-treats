...
public class ProductControllerIntegrationTest {
    ...
    public void testShowProducts() throws Exception {
        ...
        listProducts.add(new Product(1, "Product 1", 10.0, "Ingredients 1", "Nutritional Info 1", true, false, false, "photo1.jpg"));
        listProducts.add(new Product(2, "Product 2", 20.0, "Ingredients 2", "Nutritional Info 2", false, true, true, "photo2.jpg"));
